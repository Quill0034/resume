        ...
        <div className="resume-section" id="about">
            <div className="resume-section-content">
                <ScrollAnimation animateIn="fadeIn">
                    ...
                    <div className="subheading mb-5">Winnipeg, Manitoba · (431) 336-4395 · <a href="mailto:quytran0904@gmail.com">quytran0904@gmail.com</a></div>
                        <p className="lead mb-5">I am experienced in delivering software development projects and have strong passion about software testing and system analyst.</p>
