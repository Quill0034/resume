            ...
            <div className="resume-section-content">
                <ScrollAnimation animateIn="fadeIn">
                    ...
                    <div className="subheading mb-5">Winnipeg, Manitoba · (431) 336-4395 · <a href="mailto:quyhoangtran0034@gmail.com">quyhoangtran0034@gmail.com</a></div>
                        <p className="lead mb-5">I have working experience in software development projects and have a strong passion about software testing and system analyst.</p>
